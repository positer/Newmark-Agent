...
class GlassButtonCanvasOutsetContractTest {
    ...
    fun compactGlassControlsUseARealMeasuredCanvasAroundTheNominalHitBox() {
        ...
        assertTrue(liquid.contains(".glassButtonSurface(opticalShape, surfaceColor, alpha)"))
        ...
        assertTrue(scrollToBottom.contains("visualModifier = Modifier.border(1.dp, p.border2, CircleShape)"))
