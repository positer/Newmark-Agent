...
export function verifyDev009SourceContracts(): Assertion[] {
  ...
  check(hasAll(ui, [
    ...
    'var enqueue = api.sendMessage(Object.assign({}, envelope, { visibleMode: requestedMode }), lockedTarget, {',
    "requestedMode: requestedMode, inputMode: 'guide', goalObjective: envelope.goalObjective,",
    'clientMessageId: clientMessageId',
    'applyConversationCommandSnapshot(result, lockedTarget);',
    'var receipt = result && (result.receipt || result.guideReceipt) || result;',
    'force_restarting',
    'showUiNotice',
    'clearUiNotice',
