...
| Kyant AndroidLiquidGlass / backdrop 1.0.0 (`Kyant0/AndroidLiquidGlass`) | Vendored and compatibility-modified under `android/app/src/main/java/com/kyant/backdrop/` | Apache-2.0; copyright 2025 Kyant | Bundled into the Android client. Kotlin 2.0 / Compose 1.7 compatibility changes are marked in the modified source files. The complete upstream license is packaged at `android/app/src/main/res/raw/android_liquid_glass_license.txt`. |
