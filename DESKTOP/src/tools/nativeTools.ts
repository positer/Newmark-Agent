...
export const NATIVE_TOOL_CATALOG: NativeToolCatalogEntry[] = [
  ...
  { name: 'memory_lab_query', label: 'Memory Lab query', description: 'Retrieve a bounded task-relevant memory set.', category: 'memory', defaultEnabled: true },
  ...
  { name: 'memory_lab_delete', label: 'Memory Lab delete', description: 'Archive and remove obsolete Memory Lab components.', category: 'memory', defaultEnabled: true },
