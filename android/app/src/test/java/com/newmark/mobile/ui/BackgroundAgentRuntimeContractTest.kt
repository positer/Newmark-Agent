...
class BackgroundAgentRuntimeContractTest {
    ...
    fun networkRecoveryEvictsDeadRoutesAndRetriesOnlyBeforeModelActivity() {
        ...
        assertTrue(service.contains("NetworkCapabilities.TRANSPORT_VPN"))
        assertTrue(service.contains("stale callback snapshot"))
        assertTrue(service.contains("WifiManager.WIFI_MODE_FULL_LOW_LATENCY"))
