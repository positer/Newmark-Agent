...
private class DrawBackdropNode(
    ...
    private fun updateEffects() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S) {
            // Compose 1.7 invokes ObserverModifierNode reads during onAttach,
            // before the first DrawScope has supplied a concrete size. Lens
            // effects read minDimension and would throw on Size.Unspecified.
            // The first draw updates the scope and rebuilds the effect.
            if (effectScope.size == Size.Unspecified) {
