...
function inferSideEffects(name: string): ToolSideEffect {
  if (['pwd', 'read', 'glob', 'grep', 'web_search', 'web_fetch', 'browser_snapshot', 'git_status', 'file_audit', 'automation_list', 'flow_list', 'subagent_list', 'subagent_read', 'subagent_result'].includes(name)) return 'read';
