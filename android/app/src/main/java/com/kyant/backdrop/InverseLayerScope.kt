...
internal class InverseLayerScope : GraphicsLayerScope {
    ...
    // Compose 1.8+ GraphicsLayerScope properties (blendMode/colorFilter) are not part of
    // the Compose 1.7.4 GraphicsLayerScope interface this project builds against. They are
    // unused by the inverse-transform path, so they are intentionally omitted here.
