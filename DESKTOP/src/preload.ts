...
contextBridge.exposeInMainWorld('api', {
  ...
  ensureConversation: (id: string) => ipcRenderer.invoke('agent:ensureConversation', id),
  getState: (conversationId?: string) => ipcRenderer.invoke('agent:getState', conversationId),
