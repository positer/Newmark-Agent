...
export function defaultConfig(): Record<string, Record<string, ConfigEntry>> {
  ...
  return JSON.parse(JSON.stringify({
    ...
    context: {
      ...
      structured_tasks: { _description: "dev-0.3.0 structured Task list with expectedVersion", _type: "boolean", value: true },
      structured_plans: { _description: "dev-0.3.0 structured Linked Plan object", _type: "boolean", value: true },
      context_compression_v2: { _description: "dev-0.3.0 checkpoint + delta compression", _type: "boolean", value: true },
      scoped_tool_results: { _description: "dev-0.3.0 tool result lifecycle", _type: "boolean", value: true },
      provider_adapters_v2: { _description: "dev-0.3.0 unified provider adapter layer", _type: "boolean", value: true },
      agent_runtime_v2: { _description: "dev-0.3.0 Agent Run persisted state machine", _type: "boolean", value: true },
      subagent_runtime_v2: { _description: "dev-0.3.0 SubAgent persisted runs + context packages", _type: "boolean", value: true },
      capability_catalog_v1: { _description: "dev-0.3.0 capability catalog v1", _type: "boolean", value: true },
      adaptive_tool_exposure_v1: { _description: "dev-0.3.0 adaptive tool exposure planner", _type: "boolean", value: true },
      tool_schema_on_demand_v1: { _description: "dev-0.3.0 on-demand tool schema loading", _type: "boolean", value: true },
      capability_boundary_prompt_v1: { _description: "dev-0.3.0 capability boundary prompt injection", _type: "boolean", value: true },
    },
    automation: {
