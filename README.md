...
| --- | --- | --- |
| `Newmark-Agent-0.2.1-x64.msi` | Windows x64 installer with GUI and global GUI/TUI launcher | `503BE1D8155851C836B533E91B86FF0A4873444692E1C7582876B6E1CE5B7903` |
| `Newmark-Agent-0.2.1-win-unpacked-x64.zip` | Windows x64 portable | `4E93170B0667B74F114096D89A3DC8658FB2ED1A77A74EAAFD4F467DF302979C` |
| `Newmark-Agent-0.2.1-x86_64.AppImage` | Linux x64 AppImage | `62236522340F0F0F60FAC177B0C34E0EED5FFC7834E31406C1F02F09511D5624` |
| `Newmark-Agent-0.2.1-amd64.deb` | Debian/Ubuntu x64 package | `599A7425C5FE9F18AAF1EA866D393A85ED649DE1089E03EE6B9AFDC04E912CEC` |
| `Newmark-Agent-0.2.1-linux-unpacked-x64.zip` | Linux x64 portable | `EAD6B68995D3BA9F6728EE0AF236C7B522A24B6AA842CFA22E8CC6B24DEA869D` |
...
The final `dev-0.2.1` MSI and portable ZIP pass packaged Windows verification, including the global GUI/TUI launcher payload. The final MSI is installed machine-wide at `C:\Program Files\Newmark Agent`; installed and packaged `app.asar` hashes match, global `Newmark --GUI` opens the installed application, and the existing `~/.Newmark/config.json` hash remained unchanged. The preceding `dev-0.1.12` Memory Lab optimization remains included: it loads one complete visualization snapshot only when the visualization window opens, Reset is requested, or reindex finishes. Component clicks, tag search, dragging, and zooming reuse that in-memory snapshot without issuing another relationship or component read. A bounded content/index cache removes repeated disk scans from sustained queries, while explicit reads and visualization refreshes still force one current disk read.
